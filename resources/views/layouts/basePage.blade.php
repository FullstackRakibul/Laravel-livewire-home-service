...
<head>
    ...
    <meta name="author" content="Rakibul Hasan">
...
<div id="layout">
            ...
            <div class="row">
                <div class="col-md-6">
                    <ul class="visible-md visible-lg text-left">
                        <li><a href="tel:01581-500678"><i class="fa fa-phone"></i> 01581-500678</a></li>
                        <li><a href="mailto:rakibul.cse.47@gmail.com"><i class="fa fa-envelope"></i>
                                rakibul.cse.47@gmail.com</a></li>
                    </ul>
                    <ul class="visible-xs visible-sm">
                        <li class="text-left"><a href="tel:01625781547"><i class="fa fa-phone"></i>
                                01625781547</a></li>
                        <li class="text-right"><a href="index.php/changelocation.html"><i
                                    class="fa fa-map-marker"></i> Savar, Dhaka</a></li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <ul class="visible-md visible-lg text-right">
                        <li><i class="fa fa-comment"></i> Live Chat</li>
                        <li><a href="index.php/changelocation.html"><i class="fa fa-map-marker"></i> Savar , Dhaka</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <header id="header" class="header-v3">
        <nav class="flat-mega-menu">
            ...
            <ul class="collapse">
                <li class="title">
                    <a href="/"><img src="{{asset('images/rabbitic.png')}}"></a>
                </li>
                <li>
                ...
                @if(Route::has('login'))
                    @auth
                        @if(Auth::user()->usertype==='ADMIN')
                            <li class="login-form"><a href="#" title="Register">Admin Acc</a>
                                <ul class="drop-down one-column hover-fade">
                                    <li><a href="{{route('admin.dashboard')}}">Dashboard</a></li>
                                    <li><a href="{{route('admin.service_categories')}}">All Categories</a></li>
                        ...
                        @elseif(Auth::user()->usertype==='SERVICEPROVIDER')
                            <li class="login-form"><a href="#" title="Register">S Prodiver Acc</a>
                                <ul class="drop-down one-column hover-fade">
                        ...
                        @else
                            <li class="login-form"><a href="#" title="Register">Customer Acc</a>
                                <ul class="drop-down one-column hover-fade">
            ...
            <div class="row visible-md visible-lg">
                ...
                <div class="col-md-3 col-xs-6 col-sm-6">
                    ...
                    <ul class="contact_footer">
                        <li class="location">
                            <i class="fa fa-map-marker"></i> <a href="#"> Savar , Dhaka</a>
                        </li>
                        <li>
                            <i class="fa fa-envelope"></i> <a
                                href="mailto:rakibul.cse.47@gmail.com">rakibul.cse.47@gmail.com</a>
                        </li>
                        <li>
                            <i class="fa fa-headphones"></i> <a href="tel:01581500678">01581500678</a>
                        </li>
                    </ul>
            ...
            <div class="row visible-sm visible-xs">
                <div class="col-md-6">
                    ...
                    <ul class="contact_footer mlist">
                        ...
                        <li>
                            <i class="fa fa-phone"></i> <a href="tel:01581500678">01581500678</a>
                        </li>
                    </ul>
        ...
        <div class="footer-down">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <p class="text-xs-center crtext">&copy; 2022 Rabbitic Production. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
